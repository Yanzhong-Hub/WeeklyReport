...
class TushareFundamental(TusharePro):
    ...
    @staticmethod
    def finance_ratio(ts_code, start_date='', end_date=''):
        df = TusharePro.pro.fina_indicator(**{
            "ts_code": ts_code,
            "ann_date": "",
    ...
    # balance sheet
    @staticmethod
    def balance_sheet(ts_code, start_date='', end_date=''):
        df = TusharePro.pro.balancesheet(**{
            "ts_code": ts_code,
            "ann_date": "",
            "f_ann_date": "",
            "start_date": start_date,
    ...
    # income sheet
    @staticmethod
    def income_sheet(ts_code, start_date='', end_date=''):
        # 拉取数据
        df = TusharePro.pro.income(**{
            "ts_code": ts_code,
            "ann_date": "",
            "f_ann_date": "",
            "start_date": start_date,
    ...
    # cash flow report
    @staticmethod
    def cash_flow(ts_code, start_date='', end_date=''):
        df = TusharePro.pro.cashflow(**{
            "ts_code": ts_code,
            "ann_date": "",
            "f_ann_date": "",
            "start_date": start_date,
    ...
    @staticmethod
    def daily_trade_calendar(exchange='SSE', start_date='', end_date=''):
        df = TusharePro.pro.trade_cal(exchange=exchange, start_date=start_date, end_date=end_date)
        return df
